...
$result=@mysqli_query($link,$sql);
	while($row=@mysqli_fetch_assoc($result)){
		...
		echo "<table border='1'>";
		echo "<tr>";
		echo "<td width=10 colspan=2 height=10>".$row["comment"]."</td></tr><td width=5%>".$row["time"]."</td><td width=5%>"."<a href='minformc.php'>查看檢舉</a>"."</td>";
			echo "<tr>";
			echo "<td width=5%><a href='mcommentupdate.php?NO=".$row['NO']."'>編輯留言<a/></td><td width=5%>"."<a href='mdel.php?NO=".$row['NO']."'>刪除留言</a>"."</td>";

		echo "</tr>";
		echo "</table></h3>";
	}
echo "<h2><a href=mcomment.php>返回</a></h2>";
@mysqli_close($link);
