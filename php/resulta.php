...
$SQLCreate="INSERT into informa(NO,assess,reason) VALUES ('$NO','$assess','$reason')";
}

if($result=@mysqli_query($link,$SQLCreate)){
	echo "<h2>已收到您的檢舉回報，謝謝。</h2><br/><br/>";
	echo "<h2><a href=lassess.php>返回</a></h2>";
}else{
	echo "<h2><font color='red'>檢舉原因不可空白！！<br/>(將在5秒後返回上一頁)</font></h2>";
	header("refresh:5;url=lassess.php");
}
